 ...
 *
 * Ported from 4.19: include/soc/oplus/system/oplus_project.h
 * Master header aggregating OCDT and old CDT definitions.
 */
#ifndef _OPLUS_SYSTEM_PROJECT_H_
#define _OPLUS_SYSTEM_PROJECT_H_
