...
struct walt_task_struct {
	...
	/*
	 * OPLUS sched_assist per-task state. In 4.19 these were direct
	 ...
	 *
	 * Access via sa_ux_state(p) etc. from <linux/sched/sched_assist.h>.
	 * Do NOT access p->ux_state directly -- it does not exist in 5.10.
	 */
	int				ux_state;
