...
static void check_hung_uninterruptible_tasks(unsigned long timeout)
{
 ...
 unlock:
	...
	/*
	 * Dump the printk ring buffer to kmsg so the full boot log
	 * is visible in hung_task output.  Essential for debugging
	 * boot hangs where /mnt is not yet mounted.
	 */
	oplus_logbuf_dump_to_kmsg();
	oplus_screenlog_refresh();
