 ...
 *
 * Ported from 4.19: kernel/sched_assist/sync/locking_main.c
 * 5.10 adaptations: none needed (pure init/exit + module params)
 */
...
MODULE_DESCRIPTION("Oplus Locking Strategy Vendor Hooks Driver");
