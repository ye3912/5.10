...
struct walt_rq {
	...
	/*
	 * OPLUS sched_assist per-rq state. In 4.19 these were direct
	 * rq members. In 5.10 GKI they live in vendor data space
	 * via walt_rq overlaying rq->android_vendor_data1.
	 *
	 * Access via sa_ux_thread_list(rq) etc. from
	 * kernel/sched/sched_assist_internal.h.
	 */
