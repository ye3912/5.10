...
/*
 * OPLUS gauge header stub for 5.10 port
 * Original: drivers/power/oplus/oplus_gauge.h (4.19)
 *
 * Provides minimal struct definitions and function declarations
 * needed by oplus_qpnp_qg.c
 */
