...
static const struct of_device_id cam_cc_sm8250_match_table[] = {
	{ .compatible = "qcom,camcc-sm8250" },
	{ .compatible = "qcom,camcc-sm8250-v2" },
	{ }
};

static void cam_cc_sm8250_fixup_konav2(struct regmap *regmap)
{
...
static int cam_cc_sm8250_probe(struct platform_device *pdev)
{
	...
	if (of_device_is_compatible(pdev->dev.of_node,
				"qcom,camcc-sm8250-v2"))
		cam_cc_sm8250_fixup_konav2(regmap);
	else
		clk_zonda_pll_configure(&cam_cc_pll2, regmap,
					&cam_cc_pll2_config);
